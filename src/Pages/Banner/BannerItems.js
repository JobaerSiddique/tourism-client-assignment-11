   ...
   const{prev,next,id,img,head,des} =banner
    return (
          ...
          <div className="absolute  transform -translate-y-1/2 left-10 right-8 top-2/4">
            <h3 className='text-white text-7xl text-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-yellow-500 animate-pulse  '>{head}</h3> <br />
            <p data-aos="fade-up"
     data-aos-duration="3000" className='text-white mt-10 w-50 w-50 lg:w-1/2 text-2xl text-justify'>{des}</p>
            <div className="btn btn-primary mt-20">Explore</div>
          </div>
